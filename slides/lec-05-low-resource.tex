...
Evaluation, Applications, and Language Maintenance}
...
\begin{center}
   \noindent\includegraphics[width=1.0\textwidth]{img/wns-2008}
\end{center}
Green is free; Blue is research only; Brown costs money
\end{frame}
...
\begin{center}
   \noindent\includegraphics[width=1.0\textwidth]{img/wns-2023}
\end{center}
Green is free; Blue is research only; Brown costs money
\end{frame}
