...
\begin{itemize}
    ...
    \item Spoken by about 40 thousand speakers in an area stretching from the northern to the southern coast in Central Alor
      \begin{itemize}
      \item  We focus on the variety from the village of Takalelang (north coast).
      \end{itemize}
