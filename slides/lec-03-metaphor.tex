...
\title[Metaphor]{Methods in Lexical Semantics: 
  \\ Metaphor and Meaning}


\newcommand{\email}[1]{\href{mailto:#1}{#1}}
\author[Francis Bond]{Francis \ul{Bond}$^\spadesuit$
  (and Rowan Hall \ul{Maudslay}$^\diamondsuit$) } 

\institute[UPOL \& Cambridge]{$^\spadesuit$Departments of Asian Studies and Linguistics and  Sinofon Project\\
  Palacký University Olomouc \\[1ex]
  $^\diamondsuit$    CultureLab \\
  Université PSL \\[1ex]
  \email{bond@ieee.org}  
}
\date{LOT Winter School 2026} %%% FIXME
...
\begin{frame}{ChainNet}
  ...
  \end{itemize}
  % \item There was some early work on metaphor$^{**}$  \citep{alonge-2006-italian} and more recent work on metonymy \citep{khishigsuren_bella_brochhagen_marav_giunchiglia_batsuren_2022} which we discuss briefly  in .
...
\begin{itemize}
  ...
  \item Culturally grounded metaphor understanding remains a challenge for current multilingual LLMs
  \item Highlights risks for linguistic diversity and under-resourced languages in AI
\end{itemize}

\end{frame}

% --------------------------------------------------------
\begin{frame}{LLMs and metaphor: a success and a failure}
  \begin{exe}
