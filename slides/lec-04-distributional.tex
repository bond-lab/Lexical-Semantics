...
\title[Lexical meaning in the LLM era]{Word Meaning, Embeddings, and LLMs}
\author{Francis Bond}
...
\begin{frame}{We can learn these from raw text}
  ...
  \begin{itemize}
  \item 
  In word embeddings, these were learned from corpora, where a word is represented originally by a vector made of other words it appears close to, with the dimensions then reduces.
...
Model architectures are more efficient, but training is still very long.   Companies do not release detailed inform
