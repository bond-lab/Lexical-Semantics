...
\begin{tikzpicture}[node distance=10mm]
  ...
  \avmnode[below=10mm of de_hund]{synset}{ja_inu}{JA \iz{犬} (inu)};
...
\begin{frame}{Using the ILI} 
  ...
  \item A synset can be marked as \texttt{Lexicalized=False}  (default \texttt{True})
    ...
    \item If it has senses, then they are compositional phrases (like 雌虎 \jpn[female tiger]{mesu.tora} for \eng{tigress})
